...
@recipes = ["git", "setup", "gems", "testing", "email", "frontend", "extras"]
@prefs = {:dev_webserver=>"webrick", :prod_webserver=>"same", :database=>"postgresql", :git=>true, :templates=>"erb", :unit_test=>"rspec", :integration=>"cucumber", :fixtures=>"factory_girl", :form_builder=>"none", :email=>"mandrill", :authentication=>"devise", :devise_modules=>"default", :authorization=>"pundit", :frontend=>"bootstrap3", :local_env_file=>"figaro"}
